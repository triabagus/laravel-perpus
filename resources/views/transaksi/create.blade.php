                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                            ...
                            <label for="kode_transaksi" class="col-md-4 control-label">
                                Kode Transaksi
                            </label>
                        ...
                        <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                            ...
                            <label for="tgl_pinjam" class="col-md-4 control-label">
                                Tanggal Pinjam
                            </label>
                        ...
                        <div class="form-group{{ $errors->has('tgl_kembali') ? ' has-error' : '' }}">
                            ...
                            <label for="tgl_kembali" class="col-md-4 control-label">
                                Tanggal Kembali
                            </label>
                        ...
                        <div class="form-group{{ $errors->has('buku_id') ? ' has-error' : '' }}">
                            ...
                            <label for="buku_id" class="col-md-4 control-label">
                                Buku
                            </label>
                        ...
                        <div class="form-group{{ $errors->has('anggota_id') ? ' has-error' : '' }}">
                            ...
                            <label for="anggota_id" class="col-md-4 control-label">
                                Anggota
                            </label>
